...
<html lang="en">
    ...
    <body>
        <div class="centered">
            ...
            <h1><b>Aksara</b> is not installed!</h1>
            <p>
                You need to run the installation to make <b>Aksara</b> work. <a href="<?php echo base_url(); ?>"><b>Click here</b></a> to start the installation wizard.
            </p>
        </div>
    </body>
</html>
