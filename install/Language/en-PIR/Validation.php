...
return [
    // Core Messages
    'noRuleSets' => 'No rulesets specified in Validation configuration, ye scallywag.',
    'ruleNotFound' => '{0} be not a valid rule.',
    'groupNotFound' => '{0} be not a validation rules group.',
    'groupNotArray' => '{0} rule group must be an array, matey.',
    'invalidTemplate' => '{0} be not a valid Validation template.',

    // Rule Messages
    'alpha' => 'The {field} field may only contain alphabetical characters, arrr.',
    ...
    'required' => 'The {field} field be required, matey.',
    'required_with' => 'The {field} field be required when {param} is present.',
    'required_without' => 'The {field} field be required when {param} is not present.',
    ...
    // Custom
    'unique' => 'The entered {field} is already registered.',
    'boolean' => 'The {field} field can only be checked or ignored.',
    'currency' => 'The {field} field can only be formatted as currency.',
    'valid_year' => 'The {field} field must use the year format.',
    'valid_hex' => 'The {field} field may only contain a hex color code.'
];
