...
class Install extends BaseController
{
    ...
    public function requirement()
    {
        ...
        $modRewrite = ((isset($_SERVER['HTTP_MOD_REWRITE']) && strtolower($_SERVER['HTTP_MOD_REWRITE']) == 'on') || (function_exists('apache_get_modules') && in_array('mod_rewrite', apache_get_modules())) || php_sapi_name() == 'fpm-fcgi');
    ...
    public function security()
    {
        ...
        $output = [
            'encryptionKey' => $this->_random_string(64, true),
            'cookieName' => $this->_random_string(16)
        ];
