...
class MainSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->db->table('app_groups_privileges')->insertBatch([
            ...
            [
                'path' => 'xhr/widget/comment',
                'privileges' => json_encode(['index', 'update', 'repute', 'upvote', 'hide', 'report']),
                'last_generated' => date('Y-m-d H:i:s')
            ],
        ]);
        ...
        $this->db->table('app_groups')->insert([
            ...
            'group_privileges' => '{"administrative":["index"],"administrative/account":["index","edit"],"administrative/account/logs":["index","kick"],"dashboard":["index"],"xhr/partial/account":["index"],"xhr/widget/comment":["index","update","repute","upvote","hide","report"]}',
            'status' => 1
        ]);
