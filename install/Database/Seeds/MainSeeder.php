...
class MainSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->db->table('app_groups')->insert([
            ...
            'group_privileges' => '{"administrative":["index"],"administrative/account":["index","edit"],"administrative/account/passkey":["index","register","verify","delete"],"administrative/account/logs":["index","kick"],"dashboard":["index"],"xhr/partial/account":["index"],"xhr/uploader":["index","upload","delete"]}',
            'status' => 1
        ]);
