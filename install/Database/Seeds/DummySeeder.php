...
class DummySeeder extends Seeder
{
    public function run()
    {
        ...
        if (! $user) {
            throw new \RuntimeException('Cannot seed ecosystem data because app_users has no user_id to reference.');
        }
        ...
        $imagePlaceholder = base_url('uploads/pages/placeholder.png');
        $videoPlaceholder = 'https://www.youtube.com/watch?v=ZyTjlNkFfd4';

        // Insert default public menu (header navigation)
        $this->db->table('app_menus')->insert(['menu_placement' => 'header', 'menu_label' => 'Header Menu', 'menu_description' => 'Menu for navigation header (front end)', 'menu_structure' => '[{"id":"0","icon":"mdi mdi-home","label":"Home","slug":"home","newtab":"0","order":1,"children":[]},{"id":"1","icon":"mdi mdi-newspaper","label":"News","slug":"blogs","newtab":"0","order":2,"children":[]},{"id":"2","icon":"mdi mdi-map-clock-outline","label":"Galleries","slug":"galleries","newtab":"0","order":3,"children":[]},{"id":"3","icon":"mdi mdi-youtube","label":"Videos","slug":"videos","newtab":"0","order":4,"children":[]},{"id":"4","icon":"mdi mdi-dots-horizontal","label":"More","slug":"#","newtab":"0","order":5,"children":[{"id":"4","icon":"mdi mdi-account-multiple-outline","label":"Peoples","slug":"peoples","newtab":"0","order":0,"children":[]},{"id":"4","icon":"mdi mdi-bullhorn","label":"Announcements","slug":"announcements","newtab":"0","order":1,"children":[]},{"id":"4","icon":"mdi mdi-star","label":"Testimonials","slug":"testimonials","newtab":"0","order":2,"children":[]},{"id":"7","icon":"mdi mdi-dots-horizontal","label":"With Sub Menu","slug":"#","newtab":"0","order":3,"children":[{"id":"11","icon":"mdi mdi-book-open-page-variant","label":"Sample Page","slug":"pages/sample-page","newtab":"0","order":0,"children":[]},{"id":"11","icon":"mdi mdi-phone-classic","label":"Contact Us","slug":"pages/contact","newtab":"0","order":1,"children":[]},{"id":"11","icon":"mdi mdi-dots-horizontal","label":"More","slug":"#","newtab":"0","order":2,"children":[{"id":"14","icon":"mdi mdi-certificate","label":"License","slug":"pages/license","newtab":"0","order":0,"children":[]},{"id":"14","icon":"mdi mdi-information-outline","label":"About","slug":"pages/about","newtab":"0","order":1,"children":[]}]}]}]}]', 'group_id' => 0, 'status' => 1, 'created_at' => $timestamp, 'created_by' => $userId]);

        // Insert default sidebar menu
        $this->db->table('app_menus')->insert(['menu_placement' => 'sidebar', 'menu_label' => 'Sidebar Menu (Administrator)', 'menu_description' => 'Sidebar menu for global administrator', 'menu_structure' => '[{"id":"0","icon":"mdi mdi-chart-areaspline","label":"Reports","slug":"reports","newtab":"0","order":1,"children":[]}]', 'group_id' => 0, 'status' => 1, 'created_at' => $timestamp, 'created_by' => $userId]);
        $this->db->table('app_menus')->insert(['menu_placement' => 'sidebar', 'menu_label' => 'Sidebar Menu (Technical)', 'menu_description' => 'Sidebar menu for global technical staff', 'menu_structure' => '[{"id":"0","icon":"mdi mdi-chart-areaspline","label":"Reports","slug":"reports","newtab":"0","order":1,"children":[]}]', 'group_id' => 0, 'status' => 1, 'created_at' => $timestamp, 'created_by' => $userId]);
        ...
        $this->db->table('pages')->insert([
            ...
            'page_description' => 'A complete showcase of all available Page Builder components.',
            'page_content' => '{"version":"1.0","framework":"bootstrap5","components":[{"id":"hero_1","type":"hero","props":{"title":"The Complete Page Builder","subtitle":"Explore the full power of Aksara CMS with our intuitive and flexible drag-and-drop builder.","button_text":"Learn More","button_url":"#features","alignment":"center","overlay":true,"background":"' . $imagePlaceholder . '"}},{"id":"section_features","type":"section","props":{"class":"py-5","id":"features"},"children":[{"id":"container_1","type":"container","children":[{"id":"heading_feat","type":"heading","props":{"text":"Our Core Features","level":2,"alignment":"center","class":"mb-5"}},{"id":"row_feat","type":"row","children":[{"id":"col_f1","type":"column","props":{"size":{"md":4}},"children":[{"id":"f1","type":"feature_box","props":{"title":"Responsive Design","text":"Looks great on all devices.","icon":"mdi mdi-responsive"}}]},{"id":"col_f2","type":"column","props":{"size":{"md":4}},"children":[{"id":"f2","type":"feature_box","props":{"title":"Fast Loading","text":"Optimized for performance.","icon":"mdi mdi-speedometer"}}]},{"id":"col_f3","type":"column","props":{"size":{"md":4}},"children":[{"id":"f3","type":"feature_box","props":{"title":"Easy Customization","text":"Tailor it to your needs.","icon":"mdi mdi-palette-outline"}}]}]}]}]},{"id":"section_media","type":"section","props":{"class":"py-5 bg-body-tertiary"},"children":[{"id":"container_media","type":"container","children":[{"id":"row_media","type":"row","children":[{"id":"col_img","type":"column","props":{"size":{"md":6}},"children":[{"id":"h_img","type":"heading","props":{"text":"Stunning Visuals","level":3,"class":"mb-3"}},{"id":"img_1","type":"image","props":{"src":"' . $imagePlaceholder . '","alt":"Sample Image","class":"shadow rounded"}}]},{"id":"col_vid","type":"column","props":{"size":{"md":6}},"children":[{"id":"h_vid","type":"heading","props":{"text":"Video Integration","level":3,"class":"mb-3"}},{"id":"vid_1","type":"video","props":{"url":"' . $videoPlaceholder . '","ratio":"16x9","class":"rounded-4"}}]}],"props":{"align_items":"align-items-center"}}]}]},{"id":"section_carousel","type":"section","props":{"class":"py-5"},"children":[{"id":"container_carousel","type":"container","children":[{"id":"h_carousel","type":"heading","props":{"text":"Interactive Slider","level":2,"alignment":"center","class":"mb-5"}},{"id":"carousel_1","type":"carousel","props":{"items":[{"src":"' . $imagePlaceholder . '","title":"First Slide","subtitle":"Beautiful scenery awaits."},{"src":"' . $imagePlaceholder . '","title":"Second Slide","subtitle":"Modern architecture."}]}}]}]},{"id":"section_elements","type":"section","props":{"class":"py-5"},"children":[{"id":"container_elements","type":"container","children":[{"type":"heading","id":"pb_1_mp8q9pb9","props":{"level":2,"text":"Common Contents","alignment":"left","class":""}},{"id":"row_elements","type":"row","children":[{"id":"col_card","type":"column","props":{"size":{"md":4}},"children":[{"id":"card_1","type":"card","props":{"title":"Feature Card","text":"This is a card component. You can add children component into this card.","image":"' . $imagePlaceholder . '","class":""},"children":[{"type":"button","id":"pb_1_mp8ogxj7","props":{"text":"Click me","url":"#","icon":"mdi mdi-star","icon_placement":"prefix","style":"primary","size":"","class":"","target":"_self","rounded":true}}]}]},{"id":"col_alert","type":"column","props":{"size":{"md":4}},"children":[{"id":"alert_1","type":"alert","props":{"text":"<strong>Notice!</strong> Info alert.","style":"info","class":"mb-3"}},{"id":"pb_1_mp8gtlo9","type":"alert","props":{"text":"**Notice!** Warning alert.","style":"warning","class":"mb-3"}},{"id":"pb_2_mp8gtqgi","type":"alert","props":{"text":"**Notice!** Danger alert.","style":"danger","class":"mb-3"}},null,{"id":"pb_1_mp8rb0rh","type":"alert","props":{"text":"**Notice!** Primary alert.","style":"primary","class":"mb-3"}},{"id":"pb_2_mp8rb2n3","type":"alert","props":{"text":"**Notice!** Success alert.","style":"success","class":"mb-3"}},{"id":"pb_1_mp8re1e7","type":"alert","props":{"text":"**Notice!** Dark alert.","style":"dark","class":"mb-3"}}]},{"id":"col_tabs","type":"column","props":{"size":{"md":4}},"children":[{"id":"tabs_1","type":"tabs","props":{"items":[{"title":"Tab 1","content":"Content 1"},{"title":"Tab 2","content":"Content 2"}]}},{"type":"spacer","id":"pb_2_mp8i9dgs","props":{"height":"40"}},{"type":"accordion","id":"pb_1_mp8ia0vs","props":{"items":[{"title":"Item 1","body":"Content for item 1."},{"title":"Item 2","body":"Content for item 2."}],"class":""}},{"type":"spacer","id":"pb_1_mp8rdl1m","props":{"height":"40"}},{"id":"btn_1","type":"button","props":{"text":"Click Me","url":"#","style":"primary","size":"lg","rounded":true,"icon":"mdi mdi-arrow-right","icon_placement":"suffix","class":"w-100"}}]}],"props":{"align_items":"align-items-center"}}]}]},{"id":"section_pricing","type":"section","props":{"class":"py-5"},"children":[{"id":"container_pricing","type":"container","children":[{"id":"h_pricing","type":"heading","props":{"text":"Simple Pricing","level":2,"alignment":"center","class":"mb-5"}},{"id":"row_pricing","type":"row","children":[{"id":"col_p1","type":"column","props":{"size":{"md":4}},"children":[{"id":"p1","type":"pricing","props":{"title":"Starter","price":"$0","period":"/mo","features":"Basic Features\nCommunity Support\nSingle User\n1GB Storage"}}]},{"id":"col_p2","type":"column","props":{"size":{"md":4}},"children":[{"id":"p2","type":"pricing","props":{"title":"Professional","price":"$29","period":"/mo","featured":true,"features":"Advanced Features\nPriority Support\nUp to 5 Users\n10GB Storage"}}]},{"id":"col_p3","type":"column","props":{"size":{"md":4}},"children":[{"id":"p3","type":"pricing","props":{"title":"Enterprise","price":"$99","period":"/mo","features":"Unlimited Features\nDedicated Support\nUnlimited Users\n100GB Storage"}}]}]}]}]},{"id":"section_social","type":"section","props":{"class":"py-5 bg-body-tertiary"},"children":[{"id":"container_social","type":"container","children":[{"type":"heading","id":"pb_12_mp8q7qqk","props":{"level":2,"text":"Testimonial","alignment":"center","class":""}},{"id":"row_social","type":"row","children":[{"id":"col_testi","type":"column","props":{"size":{"md":6}},"children":[{"id":"testi_1","type":"testimonial","props":{"quote":"Aksara CMS significantly accelerated our development workflow. Its modular architecture and CRUD system make large-scale applications much easier to maintain.","author":"Michael Anderson","role":"CEO","image":"' . $imagePlaceholder . '"}}]},{"id":"pb_9_mp8q37qy","type":"column","props":{"size":{"md":6}},"children":[{"id":"pb_10_mp8q37qy","type":"testimonial","props":{"quote":"Database migration between MySQL and PostgreSQL was surprisingly seamless. We barely needed to change any application code.","author":"Sophia Bennett","role":"CEO","image":"' . $imagePlaceholder . '"}}]}]}]}]},{"type":"section","id":"pb_1_mp8q23b9","props":{"class":"py-5","id":"","background":""},"children":[{"type":"container","id":"pb_2_mp8q25k9","props":{"fluid":false},"children":[{"type":"heading","id":"pb_11_mp8q6cna","props":{"level":2,"text":"Peoples","alignment":"center","class":""}},{"type":"row","id":"pb_3_mp8q2bw1","props":{"class":"","align_items":"","justify_content":""},"children":[{"type":"column","id":"pb_4_mp8q2bw1","props":{"size":{"md":4},"class":"","align_self":""},"children":[{"id":"team_1","type":"team_member","props":{"name":"Aby Dahana","role":"Dev","image":"' . $imagePlaceholder . '"}}]},{"type":"column","id":"pb_5_mp8q2q1e","props":{"size":{"md":4},"class":"","align_self":""},"children":[{"id":"pb_6_mp8q2q1e","type":"team_member","props":{"name":"Jane Smith","role":"Dev","image":"' . $imagePlaceholder . '"}}]},{"type":"column","id":"pb_7_mp8q2vwz","props":{"size":{"md":4},"class":"","align_self":""},"children":[{"id":"pb_8_mp8q2vwz","type":"team_member","props":{"name":"Ethan Walker","role":"Dev","image":"' . $imagePlaceholder . '"}}]}]}]}]},{"id":"section_cta","type":"section","props":{"class":"py-5"},"children":[{"id":"container_cta","type":"container","children":[{"id":"cta_1","type":"cta","props":{"title":"Ready to Build Something Amazing?","text":"Join developers and organizations using Aksara CMS to create fast, scalable, and maintainable web applications with ease.","button_text":"Get Started","background":"primary","button_url":"https://aksaracms.com","class":"rounded-5"}}]}]}]}',
            'language_id' => 1,
            'status' => 1,
