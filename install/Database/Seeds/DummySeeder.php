...
class DummySeeder extends Seeder
{
    public function run()
    {
        $user_id = $this->db->table('app_users')
            ->select('user_id')
            ->orderBy('user_id', 'ASC')
            ->get(1)
            ->getRow('user_id');
        ...
        $this->db->table('blogs_categories')->insertBatch([
            ['category_title' => 'Uncategorized', 'category_slug' => 'uncategorized', 'category_description' => 'Uncategorized category', 'category_image' => 'placeholder.png', 'language_id' => 1, 'status' => 1, 'created_at' => $timestamp, 'created_by' => $user_id],
