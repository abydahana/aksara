...
class DummySeeder extends Seeder
{
    public function run()
    {
        ...
        $this->db->table('testimonials')->insert(['photo' => 'placeholder.png', 'first_name' => $firstName, 'last_name' => $lastName, 'testimonial_content' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'rating' => 5, 'language_id' => 1, 'status' => 1, 'created_at' => $timestamp, 'created_by' => $userId]);
