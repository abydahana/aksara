...
<div class="leading pt-5 pb-5 lazyload" style="background: url(<?php echo get_image('culinary', 'placeholder.png'); ?>) center center no-repeat; background-size: cover; position: relative" data-original="<?php echo get_image('culinary', 'cover.jpg'); ?>">
