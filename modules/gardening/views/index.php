...
<div class="leading pt-5 pb-5 lazyload" style="background: url(<?php echo get_image('gardening', 'placeholder.png'); ?>) center center no-repeat; background-size: cover; position: relative" data-original="<?php echo get_image('gardening', 'cover.jpg'); ?>">
