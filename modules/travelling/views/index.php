...
<div class="leading pt-5 pb-5 lazyload" style="background: url(<?php echo get_image('travelling', 'placeholder.png'); ?>) center center no-repeat; background-size: cover; position: relative" data-original="<?php echo get_image('travelling', 'cover.jpg'); ?>">
								...
								<div class="card border-0 shadow mr-3 mb-5 ml-3">
									...
									<div class="card-body">
										<h5 class="card-title mb-0">
											...
											<a href="' . base_url('travelling/abc') . '" class="--xhr">
