`setDescription()` mengatur deskripsi halaman dan metadata response.
...
### Perilaku
`setDescription()` menyimpan konfigurasi antarmuka pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
