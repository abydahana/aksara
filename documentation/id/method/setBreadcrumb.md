`setBreadcrumb()` adalah Core method yang tersedia di dalam controller Aksara.
...
### Perilaku
`setBreadcrumb()` menyimpan konfigurasi interface pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
