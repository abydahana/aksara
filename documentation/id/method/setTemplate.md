`setTemplate()` mengatur variable template untuk theme aktif.
...
### Perilaku
`setTemplate()` menyimpan konfigurasi antarmuka pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
