`addSubmitButton()` adalah Core method yang tersedia di dalam controller Aksara.
...
### Perilaku
`addSubmitButton()` menyimpan konfigurasi interface pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
