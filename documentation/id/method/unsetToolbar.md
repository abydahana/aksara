`unsetToolbar()` menghapus aksi toolbar berdasarkan key.

### Tujuan
`unsetToolbar()` menghapus aksi toolbar berdasarkan key. Metode ini menjaga kustomisasi modul tetap berada di alur controller Core bawaan.
...
### Perilaku
`unsetToolbar()` menyimpan konfigurasi antarmuka pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
