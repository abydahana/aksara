`unsetMethod()` menonaktifkan satu atau beberapa aksi Core.

### Tujuan
`unsetMethod()` menonaktifkan satu atau beberapa aksi Core. Metode ini menjaga kustomisasi modul tetap berada di alur controller Core bawaan.
