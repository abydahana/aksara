`setTitle()` mengatur judul halaman dan metadata response.
...
### Perilaku
`setTitle()` menyimpan konfigurasi antarmuka pada controller. Renderer aktif membacanya untuk tombol, filter, heading, layout, variable theme, atau payload output.
