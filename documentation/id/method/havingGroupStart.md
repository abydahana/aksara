`havingGroupStart()` adalah Core method yang tersedia di dalam controller Aksara.

### Tujuan
`havingGroupStart()` membuka grup kondisi HAVING. Metode ini menjaga kustomisasi modul tetap berada di alur controller Core bawaan.
