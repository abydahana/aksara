...
### Reference
`setAttribute(string|array $params = [], ?string $value = null)`
...
### Basic Usage
```php
$this->setAttribute('slug', 'data-source="title" autocomplete="off"');
...
class Orders extends Core
{
    public function index()
    {
        $this->setTitle(phrase('Orders'))
            ->setAttribute('slug', 'data-source="title" autocomplete="off"');
