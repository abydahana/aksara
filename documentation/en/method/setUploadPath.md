...
### Reference
`setUploadPath(?string $path = null)`

### Parameters
| Parameter | Type | Required | Default | Description |
|---|---|---:|---|---|
| `$path` | `?string` | No | `null` | Upload path namespace relative to the public uploads directory. |
...
### Basic Usage
```php
$this->setUploadPath('products/images');
