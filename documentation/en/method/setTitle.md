...
### Reference
`setTitle(array|string $params = [], ?string $fallback = null)`
...
### Behavior
`setTitle()` stores request-level configuration on the controller. Call it before the permission, rendering, or form-processing step that depends on it.
