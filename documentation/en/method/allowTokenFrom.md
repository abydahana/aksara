`allowTokenFrom()` accepts security tokens generated for additional URIs. It is used inside an Aksara controller as part of the Core method API.
...
|---|---|---:|---|---|
| `$uris` | `string|array` | No | `[]` | URI or URI list accepted as token sources. |
