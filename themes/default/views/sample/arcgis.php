...
<div class="py-3 py-md-5">
	<div class="container">
		<div class="rounded-4 overflow-hidden position-relative">
			<div role="map" class="full-height bg-light" data-zoom="12" data-rest-url="https://jakartasatu.jakarta.go.id/server/rest/services/BATAS_ADMINSTRASI_RW_DKI_JAKARTA/FeatureServer/0"></div>
		</div>
		<br />
		<br />
		<b>
...
<code>&lt;div
    ...
    data-zoom="12"
     data-rest-url="https://jakartasatu.jakarta.go.id/server/rest/services/BATAS_ADMINSTRASI_RW_DKI_JAKARTA/FeatureServer/0"
&gt;&lt;/div&gt;</code>
		</pre>
	</div>
</div>
