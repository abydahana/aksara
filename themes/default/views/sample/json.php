...
<div class="py-3 py-md-5">
	<div class="container">
		<div class="rounded-4 overflow-hidden position-relative">
			<div role="map" class="full-height bg-light" data-zoom="12" data-source-url="<?= get_file('geospatial', 'sample.json'); ?>"></div>
		</div>
		<br />
		<br />
		<b>
...
<code>&lt;div role="map"
	...
	data-zoom="12"
	data-source-url="<?= get_file('geospatial', 'sample.json'); ?>"
&gt;&lt;/div&gt;</code>
		</pre>
	</div>
</div>
