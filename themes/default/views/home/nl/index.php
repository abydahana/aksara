    ...
    <div class="container">
        <div class="section-padding fade-in">
            ...
            <div class="d-flex justify-content-center gap-3 mb-5">
                <a href="<?= base_url('auth'); ?>" class="btn btn-primary rounded-pill px-4 --modal">BEGIN NU</a>
            </div>
...
<section class="section-padding fade-in">
    <div class="container text-center">
        <p class="text-muted fw-semibold mb-4">Vertrouwd door organisaties en bedrijven</p>
...
<section class="section-padding fade-in bg-light">
    <div class="container text-center">
        <h2 class="fw-bold mb-5 display-6">Gemeenschap & Betrokkenheid</h2>
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->daily); ?></h2>
                <h5 class="fw-bold mb-2">Dagelijkse Bezoeken</h5>
                <p class="text-muted small mb-0">Unieke bezoekers vandaag.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->weekly); ?></h2>
                <h5 class="fw-bold mb-2">Wekelijkse Bezoeken</h5>
                <p class="text-muted small mb-0">Totale bezoeken deze week.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->monthly); ?></h2>
                <h5 class="fw-bold mb-2">Maandelijkse Bezoeken</h5>
                <p class="text-muted small mb-0">Totale bezoeken deze maand.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->yearly); ?></h2>
                <h5 class="fw-bold mb-2">Jaarlijkse Bezoeken</h5>
                <p class="text-muted small mb-0">Totale bezoeken dit jaar.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->posts); ?></h2>
                <h5 class="fw-bold mb-2">Gepubliceerde Artikelen</h5>
                <p class="text-muted small mb-0">Totaal beschikbare inhoud.</p>
            </div>
            <div class="col-6 col-md-4 mb-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->comments); ?></h2>
                <h5 class="fw-bold mb-2">Interacties</h5>
                <p class="text-muted small mb-0">Gebruikersreacties en feedback.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Uitgelichte Galerijen</h3>
        </div>
        <div class="row">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('galleries'); ?>" class="text-decoration-none fw-semibold --xhr">Bekijk alle galerijen <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Laatste Nieuws</h3>
        </div>
        <div class="row">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('blogs'); ?>" class="text-decoration-none fw-semibold --xhr">Bekijk al het nieuws <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section-padding pb-0 border-fade-top text-center fade-in">
    <div class="container">
        <h2 class="fw-bold mb-3">Bouw Uw Applicatie Vandaag</h2>
        <p class="text-secondary mb-4">Download de volledige broncode van <strong>Aksara CMS</strong> en begin met het bouwen van uw eigen platform zonder beperkingen.</p>
        <div class="d-flex justify-content-center">
            <a href="https://github.com/abydahana/aksara" target="_blank" class="btn btn-primary rounded-pill px-4"><i class="mdi mdi-github"></i> BRONCODE OPHALEN</a>
        </div>
    </div>
</section>
