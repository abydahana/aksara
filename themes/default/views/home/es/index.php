...
<section class="section-padding fade-in">
    <div class="container text-center">
        <p class="text-muted fw-semibold mb-4">Con la confianza de organizaciones y empresas</p>
...
<section class="section-padding fade-in bg-light">
    <div class="container text-center">
        <h2 class="fw-bold mb-5 display-6">Comunidad e Interacción</h2>
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 mb-5">
                ...
                <p class="text-muted small mb-0">Visitantes únicos hoy.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
            ...
            <div class="col-6 col-md-4 mb-5">
                ...
                <p class="text-muted small mb-0">Total de visitas este mes.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                ...
                <p class="text-muted small mb-0">Total de visitas este año.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->posts); ?></h2>
                <h5 class="fw-bold mb-2">Artículos Publicados</h5>
                <p class="text-muted small mb-0">Contenido total disponible.</p>
            </div>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Galerías Destacadas</h3>
        </div>
        <div class="row">
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Últimas Noticias</h3>
        </div>
        <div class="row">
...
<section class="section-padding pb-0 border-fade-top text-center fade-in">
    <div class="container">
        <h2 class="fw-bold mb-3">Construye tu Aplicación Hoy</h2>
        <p class="text-secondary mb-4">Obtén el código fuente completo de <strong>Aksara CMS</strong> y comienza a construir tu propia plataforma sin limitaciones.</p>
