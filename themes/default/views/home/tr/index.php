    ...
    <div class="container">
        <div class="section-padding fade-in">
            ...
            <div class="d-flex justify-content-center gap-3 mb-5">
                <a href="<?= base_url('auth'); ?>" class="btn btn-primary rounded-pill px-4 --modal">BAŞLAYIN</a>
            </div>
...
<section class="section-padding fade-in bg-light">
    <div class="container text-center">
        <h2 class="fw-bold mb-5 display-6">Topluluk ve Katılım</h2>
        <div class="row justify-content-center">
            ...
            <div class="col-6 col-md-4 mb-0">
                ...
                <h5 class="fw-bold mb-2">Etkileşimler</h5>
...
<section class="section-padding fade-in">
    <div class="container">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('galleries'); ?>" class="text-decoration-none fw-semibold --xhr">Tüm galerileri gör <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section-padding fade-in">
    <div class="container">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('blogs'); ?>" class="text-decoration-none fw-semibold --xhr">Tüm haberleri gör <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
