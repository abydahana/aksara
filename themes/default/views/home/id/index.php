    ...
    <div class="container">
        <div class="section-padding fade-in">
            ...
            <div class="d-flex justify-content-center gap-3 mb-5">
                <a href="<?= base_url('auth'); ?>" class="btn btn-primary rounded-pill px-4 --modal">MULAI SEKARANG</a>
            </div>
...
<section class="section-padding fade-in">
    <div class="container text-center">
        <p class="text-muted fw-semibold mb-4">Dipercaya oleh Organisasi dan Perusahaan</p>
...
<section class="section-padding fade-in bg-light">
    <div class="container text-center">
        <h2 class="fw-bold mb-5 display-6">Komunitas & Interaksi</h2>
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 mb-5">
                ...
                <p class="text-muted small mb-0">Pengunjung unik hari ini.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
                ...
                <p class="text-muted small mb-0">Total kunjungan minggu ini.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
            ...
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                ...
                <p class="text-muted small mb-0">Total konten tersedia.</p>
            </div>
            <div class="col-6 col-md-4 mb-0">
                ...
                <p class="text-muted small mb-0">Komentar & umpan balik pengguna.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Berita terbaru</h3>
        </div>
        <div class="row">
