    ...
    <div class="container">
        <div class="section-padding fade-in">
            ...
            <div class="d-flex justify-content-center gap-3 mb-5">
                <a href="<?= base_url('auth'); ?>" class="btn btn-primary rounded-pill px-4 --modal">COMEÇAR</a>
            </div>
...
<section class="section-padding fade-in">
    <div class="container text-center">
        <p class="text-muted fw-semibold mb-4">Confiado por organizações e empresas</p>
...
<section class="section-padding fade-in bg-light">
    <div class="container text-center">
        <h2 class="fw-bold mb-5 display-6">Comunidade e Engajamento</h2>
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->daily); ?></h2>
                <h5 class="fw-bold mb-2">Visitas Diárias</h5>
                <p class="text-muted small mb-0">Visitantes únicos hoje.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->weekly); ?></h2>
                <h5 class="fw-bold mb-2">Visitas Semanais</h5>
                <p class="text-muted small mb-0">Total de visitas esta semana.</p>
            </div>
            <div class="col-6 col-md-4 mb-5">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->monthly); ?></h2>
                <h5 class="fw-bold mb-2">Visitas Mensais</h5>
                <p class="text-muted small mb-0">Total de visitas este mês.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->yearly); ?></h2>
                <h5 class="fw-bold mb-2">Visitas Anuais</h5>
                <p class="text-muted small mb-0">Total de visitas este ano.</p>
            </div>
            <div class="col-6 col-md-4 mb-4 mb-md-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->posts); ?></h2>
                <h5 class="fw-bold mb-2">Artigos Publicados</h5>
                <p class="text-muted small mb-0">Conteúdo total disponível.</p>
            </div>
            <div class="col-6 col-md-4 mb-0">
                <h2 class="display-4 fw-bold text-primary mb-2"><?= number_format($statistics->comments); ?></h2>
                <h5 class="fw-bold mb-2">Interações</h5>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Galerias em Destaque</h3>
        </div>
        <div class="row">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('galleries'); ?>" class="text-decoration-none fw-semibold --xhr">Ver todas as galerias <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section-padding fade-in">
    <div class="container">
        <div class="text-center mb-5">
            <h3 class="fw-bold m-0 display-6">Últimas Notícias</h3>
        </div>
        <div class="row">
        ...
        <div class="mt-5 text-center">
            <a href="<?= base_url('blogs'); ?>" class="text-decoration-none fw-semibold --xhr">Ver todas as notícias <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="section-padding pb-0 border-fade-top text-center fade-in">
    <div class="container">
        <h2 class="fw-bold mb-3">Construa Sua Aplicação Hoje</h2>
        <p class="text-secondary mb-4">Obtenha o código-fonte completo do <strong>Aksara CMS</strong> e comece a construir sua própria plataforma sem limitações.</p>
        <div class="d-flex justify-content-center">
            <a href="https://github.com/abydahana/aksara" target="_blank" class="btn btn-primary rounded-pill px-4"><i class="mdi mdi-github"></i> OBTER CÓDIGO FONTE</a>
        </div>
    </div>
</section>
