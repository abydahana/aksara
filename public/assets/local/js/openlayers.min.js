...
const openlayers = (function() {
    return {
        ...
        wms: function(source) {
            ...
            // Fit map to features
            wmsTile.getSource().once('change', function(e) {
                if (wmsTile.getSource().getState() === 'ready') {
                    if (wmsTile.getSource().getExtent().length && $.inArray(Infinity, wmsTile.getSource().getExtent()) === -1) {
                        map.getView().fit(wmsTile.getSource().getExtent(), {
                            size: map.getSize()
                        });
                    }
                }
            ...
            map.on('singleclick', function(event) {
                ...
                const url = wmsTile.getSource().getFeatureInfoUrl(
                    event.coordinate,
