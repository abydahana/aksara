  ...
  return {
    ...
    geometryEditor: function(options) {
      ...
      function handleStyle(handleType, anchor, coord) {
        ...
        let styles = [];
        if (isRotate && options.showRotateConnector && anchor && coord) {
      ...
      function updateHandles() {
        ...
        items.forEach(function(mainFeature) {
          ...
          if (type === 'LineString') {
            ...
            let deleteCoord = [centroid[0] + polygonDeleteOffset, centroid[1] + polygonDeleteOffset];
            addHandle(source, 'rotate', centroid, null, mainFeature);
            addHandle(source, 'delete', deleteCoord, null, mainFeature);
          }
        });
      }
      ...
      if (options.delete !== false) {
        select = new ol.interaction.Select({
          ...
          style: options.selectStyle || new ol.style.Style({
            stroke: new ol.style.Stroke({
              color: hex2rgba('#0099ff', 1),
              width: 2
            }),
            fill: new ol.style.Fill({
              color: hex2rgba('#0099ff', .08)
            })
          })
        });
