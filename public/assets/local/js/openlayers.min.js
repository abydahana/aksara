			...
			if(type)
			{
				...
				highlight.on('select', function(event)
				{
					if(event.selected.length)
					{
						...
						popup.show(event.mapBrowserEvent.coordinate, ('<div class="popup-placeholder"><div class="pt-2 pe-3 pb-2 ps-3 border-bottom"><label class="font-weight-bold d-block mb-0"><i class="mdi mdi-menu" style="width:30px; display:inline-block"></i> ' + (phrase.options ? phrase.options : 'Options') + '</label></div><div class="popup-content"><div class="list-group list-group-flush"><a href="javascript:void(0)" class="list-group-item list-group-item-action p-3" onclick="removeFeature()"><i class="mdi mdi-trash-can-outline"></i> ' + (phrase.remove_feature ? phrase.remove_feature : 'Remove feature') + '</a></div></div></div>'))
