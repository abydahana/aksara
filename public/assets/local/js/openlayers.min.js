...
const openlayers = (function() {
    return {
        render: function(_this) {
            ...
            lngLat = (context.data('coordinate') ? context.data('coordinate') : (context.data('map-center') ? JSON.parse(context.data('map-center')) : []));
        ...
        download: function(type, format, dpi) {
            /**
             * Download
             */
            if ('png' == type) {
                ...
                if (canvas && typeof canvas[0] !== 'undefined') {
                    require.js([
                        ...
                        let unit = map.getView().getProjection().getUnits(),
                            resolution = map.getView().getResolution(),
                            format = ($.inArray(format, ['a0', 'a1', 'a2', 'a3', 'a4', 'a5']) !== -1 ? format : 'a4'),
                            doc = new jsPDF({
