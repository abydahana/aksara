		...
		render: function(_this_)
		{
			...
			else
			{
				...
				map.on('singleclick', function(event)
				{
					 ...
					 */
					popup.show(event.coordinate, ('<div class="popup-placeholder"><div class="popup-content"><div class="d-flex justify-content-center p-3"><div class="spinner-border spinner-border-sm" role="status"><span class="sr-only">' + (phrase.loading ? phrase.loading : 'Loading...') + '</span></div></div></div></div>'));
