			...
			else
			{
				for(i = 0; i < count; i++)
				{
					if(segmentation_backup)
					{
						...
						if(segmentation_backup && $('[data-segmentation=' + segmentation_backup.replace('|', '_') + ']').length)
						{
							$('[data-segmentation=' + segmentation_backup.replace('|', '_') + ']').parents('li').addClass('active');
			...
			$('.swiper').each(function()
			{
				...
				var swiper							= new Swiper('.swiper_' + _unique,
				{
					...
					breakpoints:
					{
						640:
						{
							slidesPerView: (typeof _this.attr('data-sm-items') !== 'undefined' ? _this.attr('data-sm-items') : (typeof _this.attr('data-items') !== 'undefined' ? parseInt(_this.attr('data-items')) : 'auto')),
							spaceBetween: (typeof _this.attr('data-space-between') !== 'undefined' ? parseInt(_this.attr('data-space-between')) : 15)
						},
						768:
						{
							slidesPerView: (typeof _this.attr('data-md-items') !== 'undefined' ? _this.attr('data-md-items') : (typeof _this.attr('data-sm-items') !== 'undefined' ? _this.attr('data-sm-items') : (typeof _this.attr('data-items') !== 'undefined' ? parseInt(_this.attr('data-items')) : 'auto'))),
							spaceBetween: (typeof _this.attr('data-space-between') !== 'undefined' ? parseInt(_this.attr('data-space-between')) : 15)
						},
						1024:
						{
							slidesPerView: (typeof _this.attr('data-lg-items') !== 'undefined' ? _this.attr('data-lg-items') : (typeof _this.attr('data-md-items') !== 'undefined' ? _this.attr('data-md-items') : (typeof _this.attr('data-items') !== 'undefined' ? parseInt(_this.attr('data-items')) : 'auto'))),
							spaceBetween: (typeof _this.attr('data-space-between') !== 'undefined' ? parseInt(_this.attr('data-space-between')) : 15)
						},
						1280:
						{
							slidesPerView: (typeof _this.attr('data-xl-items') !== 'undefined' ? _this.attr('data-xl-items') : (typeof _this.attr('data-lg-items') !== 'undefined' ? _this.attr('data-lg-items') : (typeof _this.attr('data-items') !== 'undefined' ? parseInt(_this.attr('data-items')) : 'auto'))),
							spaceBetween: (typeof _this.attr('data-space-between') !== 'undefined' ? parseInt(_this.attr('data-space-between')) : 15)
						}
					},
					pagination:
