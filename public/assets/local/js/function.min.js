...
function reactivate(individual, ignoreSelf) {
  ...
  if ($('select[data-role=select]').length && (!individual.length || individual.includes('select')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/select2/select2.min.css',
      config.baseUrl + 'assets/select2/select2-bootstrap-5-theme.min.css',
      config.baseUrl + 'assets/local/css/select2.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/select2/select2.min.js'
    ], function() {
  ...
  if ($('[data-role=wysiwyg]').length && (!individual.length || individual.includes('wysiwyg')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/summernote/summernote.min.css',
      config.baseUrl + 'assets/local/css/summernote.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/summernote/summernote.min.js'
    ], function() {
  ...
  if ($('.swiper').length && (!individual.length || individual.includes('swiper')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/swiper/swiper-bundle.min.css',
      config.baseUrl + 'assets/local/css/swiper.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/swiper/swiper-bundle.min.js'
    ], function() {
  ...
  if ($('[data-role=videoplayer]').length && (!individual.length || individual.includes('videoplayer')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/mediaelement/mediaelement.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/mediaelement/mediaelement.min.js'
    ], function() {
  ...
  if ($('[data-role=calendar]').length && (!individual.length || individual.includes('calendar')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/fullcalendar/fullcalendar.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/fullcalendar/fullcalendar.min.js'
    ], function() {
  ...
  if ($('[data-role=money]').length && (!individual.length || individual.includes('money')) && !ignoreSelf) {
    require.js([
      config.baseUrl + 'assets/autonumeric/autonumeric.min.js'
    ], function() {
      let moneyOptions = {
        vMin: '-999999999.99'
      };
  ...
  if ($('[data-role=autocomplete]').length && (!individual.length || individual.includes('autocomplete')) && !ignoreSelf) {
    require.js([
      config.baseUrl + 'assets/autocomplete/autocomplete.min.js'
    ], function() {
  ...
  if ($('[data-role=map]').length && (!individual.length || individual.includes('map')) && !ignoreSelf) {
    $('[data-role=map]').each(function() {
      ...
      require.css([
        ...
        config.baseUrl + 'assets/openlayers/ol-popup/ol-popup.min.css', config.baseUrl + 'assets/local/css/openlayers.min.css'
      ]);
  ...
  if ($('pre code').length && (!individual.length || individual.includes('code')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/prism/prism.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/prism/prism.min.js'
    ], function() {
      Prism.highlightAll();
    });
  }
  ...
  if ($('[data-role=iconpicker]').length && (!individual.length || individual.includes('iconpicker')) && !ignoreSelf) {
    require.css([
      config.baseUrl + 'assets/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css'
    ]);
    require.js([
      config.baseUrl + 'assets/bootstrap-iconpicker/js/iconset/materialdesignicons.3.9.97.min.js',
      config.baseUrl + 'assets/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js'
    ], function() {
  ...
  if ($('[data-role=sortable-menu]').length && (!individual.length || individual.includes('sortable-menu')) && !ignoreSelf) {
    $('[data-role=sortable-menu]').each(function() {
      ...
      require.css([
        config.baseUrl + 'assets/sortable/sortable.min.css'
      ]);
      require.js([
        config.baseUrl + 'assets/sortable/sortable.min.js'
      ], function() {
        context.sortable({
            maxDepth: maxDepth,
            selector: "ul",
  ...
  if ($('[data-role=sortable]').length && (!individual.length || individual.includes('sortable')) && !ignoreSelf) {
    $('[data-role="sortable"]').each(function() {
      ...
      require.js([
        config.baseUrl + 'assets/sortable/jquery-ui.sortable.min.js'
      ], function() {
        context.sortable({
          axis: 'y',
          containment: 'parent',
