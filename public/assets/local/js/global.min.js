          ...
          <div class="form-group mb-3">
            ...
            <div data-provides="fileupload" class="fileupload fileupload-new">
              <span class="btn btn-file d-block">
                <input type="file" name="${$(this).attr('data-field')}[background][${length}]" accept="images/*" role="image-upload" id="${$(this).attr('data-field')}_bg_${length}_input" />
                <div class="fileupload-new text-center">
                  <img class="img-fluid upload_preview rounded" src="${$(this).attr('data-image-placeholder')}" alt="${phrase('Preview')}" />
                </div>
                    ...
                    <div class="row g-0">
                      <div class="col-2">
                        <div class="position-relative">
                          ...
                          <img src="${val.avatar}" class="rounded-circle img-fluid" alt="${val.user}" />
                        </div>
                      </div>
  ...
  $('body').on('click', '.captcha-refresh', function(e) {
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.image) {
          container.html('<img src="' + response.image + '" class="img-fluid" alt="CAPTCHA" />');
