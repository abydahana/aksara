...
$(document).ready(function()
{
	 ...
	 */
	var segmentation								= (location.protocol + '//' + location.host + location.pathname).replace(config.base_url, ''),
		...
		if('_blank' != $(this).attr('target'))
		{
			...
			.done(function(response)
			{
				...
				if(typeof response.meta !== 'undefined' && typeof response.meta.popup !== 'undefined' && response.meta.popup)
				{
					...
					$('#will-be-replace-with-title').text(' ' + _old_title),
					$('#will-be-replace-with-icon').removeAttr('class').addClass(_old_icon)
				}
				else
				{
					/* push response token to session storage */
