...
$(document).ready(function() {
  ...
  $('body:not(.no-ajax)').on('click touch', 'a.--xhr, a.--modal', function(e) {
    ...
    if (!$(this).attr('href') || $(this).attr('href') === '#' || $(this).attr('href') === 'javascript:void(0)' || $(this).attr('data-bs-toggle') === 'dropdown' || $(this).hasClass('dropdown-toggle') || $(this).attr('href').indexOf(config.baseUrl) === -1 || $(this).attr('target')) {
      return;
    }
  ...
  $('body').on('shown.bs.modal', '.modal', function(e) {
    ...
    .on('shown.bs.modal', '.modal:not(.dragless)', function(e) {
      ...
      require.js([
        config.baseUrl + 'assets/draggable/jquery-ui.draggable.min.js'
      ], function() {
      ...
      .done(function(response) {
        if (navigator.share && typeof response.meta !== 'undefined' && typeof response.links !== 'undefined') {
          navigator.share({
              ...
              url: response.links.currentPage
            }).then(() => {
