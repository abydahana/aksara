    ...
    render: function(context, response, popstate, oldStuff) {
      ...
      if (typeof response.message !== 'undefined') {
        ...
        if (context.data('identifier') && '.modal#dynamic-modal-' + context.data('identifier').length) {
          ...
          $('.modal#dynamic-modal-' + context.data('identifier')).find('.modal-dialog').removeClass('modal-sm modal-md modal-lg modal-xl modal-xxl').addClass(response.meta.modalSize);
        ...
        if (!context.hasClass('--keep-modal')) {
          // Hide previous modal
          $('.modal.show').not('#' + oldStuff?.parent_modal).modal('hide');
        }
        ...
        if (response.prefer === 'modal') {
          ...
          if (!popstate && typeof response.links !== 'undefined') {
            ...
            history.pushState({
              path: response.links.currentPage
            }, response.meta.title, response.links.currentPage);
          }
        }
        ...
        if (typeof response.links !== 'undefined') {
          ...
          $('[data-role=reload]').attr('href', (response.links.currentPage ? response.links.currentPage : context.attr('href')));
        }
