      ...
      if (typeof response.message !== 'undefined') {
        ...
        if (response.prefer === 'modal') {
          ...
          if (!popstate && typeof response.links !== 'undefined') {
            ...
            history.pushState({
              path: response.links.current_page
            }, response.meta.title, response.links.current_page);
          }
        }
        ...
        if (typeof response.links !== 'undefined') {
          ...
          $('[data-role=reload]').attr('href', (response.links.current_page ? response.links.current_page : context.attr('href')));
        }
