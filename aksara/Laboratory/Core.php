				...
				else if(array_intersect(array('boolean'), $type))
				{
					$content						= '
						<label class="d-block pt-1">
							<input type="checkbox" name="' . $field . '" value="1" id="' . $field . '_input"' . ($default_value == 1 || $default_value == $original || 1 == $original || ('create' == $this->_method && $default_value) ? ' checked' : null) . $read_only . ' />
							&nbsp;
