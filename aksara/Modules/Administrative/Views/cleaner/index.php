        ...
        <div class="col-lg-7">
            <div class="alert alert-warning rounded-4 callout">
                <p>
                    ...
                    <?= phrase('You are about to clean up unused session garbage.') . ' ' . phrase('All inactive session within {{hour}} hours will be removed.', ['hour' => $hour]) . ' ' . phrase('This action cannot be undone.'); ?>
                </p>
