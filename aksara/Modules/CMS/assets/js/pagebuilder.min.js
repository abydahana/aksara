    ...
    const loadImages = function() {
      ...
      fetch(url).then(res => res.json()).then(data => {
        ...
        if (totalPages > 1) {
          ...
          ph += '<div class="pb-page-btn ' + (state.page === totalPages ? 'disabled' : '') + '" data-page="' + (state.page + 1) + '"><i class="mdi mdi-chevron-right"></i></div>';
