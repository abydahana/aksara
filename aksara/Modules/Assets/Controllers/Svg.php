...
class Svg extends Core
{
    ...
    public function __construct()
    {
        ...
        $this->_fill = $this->_validateHex($this->request->getGet('fill'));
        $this->_stroke = $this->_validateHex($this->request->getGet('stroke'));
    }
    ...
    {
        if ($hexColor && preg_match('/#([a-f0-9]{3}){1,2}\b/i', $hexColor)) {
            return $hexColor;
        }
