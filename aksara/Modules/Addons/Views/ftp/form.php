					...
					<div class="col-md-9">
						<div class="form-group">
							<label class="text-muted d-block" for="hostname_input">
								...
								<?php echo ($results->form_data->hostname->required ? '<span class="float-right text-sm text-danger">' . phrase('required') . '</span>' : null); ?>
							</label>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="text-muted d-block" for="port_input">
								...
								<?php echo ($results->form_data->port->required ? '<span class="float-right text-sm text-danger">' . phrase('required') . '</span>' : null); ?>
							</label>
