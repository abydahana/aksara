  ...
  Prototype.renderContent = function(component) {
    ...
    switch (component.type) {
      ...
      case 'button':
        ...
        return '<span class="btn btn-' + (props.style || 'primary') + ' btn-sm' + (props.rounded ? ' rounded-pill' : '') + '" style="pointer-events:none">' + btnContent + '</span>';
      case 'image':
      ...
      case 'card':
        ...
        return cardImg + '<div class="p-3"><strong>' + phrase(props.title || 'Card Title') + '</strong><br><small>' + phrase(props.text || '') + '</small></div>';
      case 'spacer':
