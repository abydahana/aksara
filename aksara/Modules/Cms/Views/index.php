<div class="container-fluid pt-3 pb-3">
	<div class="row">
		<div class="col-md-4">
			<a href="<?php echo go_to('blogs'); ?>" class="card text-white bg-secondary mb-3 --xhr">
		...
		<div class="col-md-4">
			<a href="<?php echo go_to('pages'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
						...
						<div class="col">
							...
							<p class="card-text">
								<?php echo phrase('manage_front_end_pages'); ?>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="col-md-4">
			<a href="<?php echo go_to('galleries'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
	...
	<div class="row">
		<div class="col-md-4">
			<a href="<?php echo go_to('peoples'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
						...
						<div class="col">
							...
							<p class="card-text">
								<?php echo phrase('manage_peoples'); ?>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="col-md-4">
			<a href="<?php echo go_to('partials/announcements'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
		...
		<div class="col-md-4">
			<a href="<?php echo go_to('partials/carousels'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
	...
	<div class="row">
		<div class="col-md-8">
			<a href="<?php echo go_to('partials/faqs'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
		...
		<div class="col-md-4">
			<a href="<?php echo go_to('partials/media'); ?>" class="card text-white bg-secondary mb-3 --xhr">
				<div class="card-body pt-2 pr-3 pb-2 pl-3">
					<div class="row">
						<div class="col-3">
