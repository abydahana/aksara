        ...
        <div class="col-md-9">
            <div>
                ...
                <?php else: ?>
                    ...
                    <p>
                        To be able to use the API request feature, you need to first add an API key from the <a href="<?= go_to(
                          '../services',
                        ) ?>" class="text-primary"><b>API Services Management</b></a> menu. Specify the allowed request method, the allowed IP range and also the expiration date of the generated API key.
                    </p>
                    <p>
                    ...
                    <p>
                        When you are requesting the data, there are query string helper (which mentioned under the "<code>queryParams</code>") that will help you to retrieving the data to be matched with the query string keywords. Besides that, this also available query string helper to retrieving the specified results.
                    </p>
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            <thead>
