...
return [
    'missingDatabaseTable' => '데이터베이스 세션 핸들러가 동작하기 위해서, 반드시 "sessionSavePath"에 테이블 명이 지정되어야 합니다.', // 'Session: "savePath" must have the table name for the Database Session Handler to work.'
