...
return [
    ...
    'invalidSMTPAuthMethod' => 'Error: el método de autorización SMTP "{0}" no es compatible con codeigniter; configure el método de autorización "login" o "plain"',
    'failureSMTPAuthMethod' => 'No se puede iniciar el comando AUTH. Es posible que su servidor no esté configurado para usar el método de autenticación AUTH {0}.',
    'SMTPAuthCredentials' => 'No se pudieron autenticar las credenciales del usuario. Error: {0}',
