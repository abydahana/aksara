...
return [
    ...
    'alpha_numeric_punct' => '欄位 {field} 的組成只能是字母數字、空格，以及 ~ ! # $ % & * - _ + = | : 等字元。',
    ...
    'is_not_unique' => '欄位 {field} 必須包含資料庫中已經存在的數值。',
    ...
    'not_in_list' => '欄位 {field} 不能是：{param} 其中之一。',
    ...
    // Custom
    'unique' => '您輸入的 {field} 已被註冊。',
    'boolean' => '{field} 必須被選中或被忽略。',
    'currency' => '{field} 必須包含有效的貨幣。',
    'valid_time' => '{field} 必須包含有效的時間。',
    'valid_datetime' => '{field} 必須包含有效的日期和時間。',
    'valid_year' => '{field} 必須包含有效的年份。',
    'valid_hex' => '{field} 必須只包含十六進位顏色代碼。',
    'valid_geojson' => '{field} 必須包含有效的 GeoJSON。',
    'relation_checker' => '未找到 {field} 的關聯數據。'
];
