...
return [
    ...
    // Custom
    'unique' => '{field} bạn nhập đã được đăng ký.',
    'boolean' => '{field} phải được đánh dấu hoặc bỏ qua.',
    'currency' => '{field} phải chứa tiền tệ hợp lệ.',
    'valid_time' => '{field} phải chứa thời gian hợp lệ.',
