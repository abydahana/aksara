...
return [
    ...
    // Custom
    'unique' => 'تم تسجيل {field} الذي أدخلته مسبقاً.',
    'boolean' => 'يجب تحديد {field} أو تجاهله.',
    'currency' => 'يجب أن يحتوي {field} على عملة صالحة.',
    'valid_time' => 'يجب أن يحتوي {field} على وقت صالح.',
