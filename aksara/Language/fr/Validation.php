...
return [
    ...
    // Custom
    'unique' => 'Le {field} que vous avez saisi est déjà enregistré.',
    'boolean' => 'Le {field} doit être coché ou plutôt ignoré.',
    'currency' => 'Le {field} doit contenir une devise valide.',
    'valid_time' => 'Le {field} doit contenir une heure valide.',
