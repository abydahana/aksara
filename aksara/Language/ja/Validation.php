...
return [
    ...
    'valid_json'            => '{field} には有効なJSONを入力してください。', // 'The {field} field must contain a valid json.'
    ...
    'boolean' => '{field} はチェックされるか、無視される必要があります。',
    'currency' => '{field} には有効な通貨が含まれている必要があります。',
    'valid_time' => '{field} には有効な時間が含まれている必要があります。',
