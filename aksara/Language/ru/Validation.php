...
return [
    ...
    // Custom
    'unique' => 'Введенное вами поле {field} уже зарегистрировано.',
    'boolean' => 'Поле {field} должно быть отмечено или проигнорировано.',
    'currency' => 'Поле {field} должно содержать действительную валюту.',
    'valid_time' => 'Поле {field} должно содержать действительное время.',
    'valid_datetime' => 'Поле {field} должно содержать действительные дату и время.',
    'valid_year' => 'Поле {field} должно содержать действительный год.',
    'valid_hex' => 'Поле {field} должно содержать только шестнадцатеричный код цвета.',
    'valid_geojson' => 'Поле {field} должно содержать действительный GeoJSON.',
    'relation_checker' => 'Данные отношения для {field} не найдены.'
];
