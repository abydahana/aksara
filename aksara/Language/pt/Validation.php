...
return [
    ...
    'is_not_unique' => 'O campo {field} deve conter apenas um valor pre existente na base de dados.',
    ...
    'not_in_list' => 'O campo {field} não pode fazer parte de: {param}.',
    ...
    'string' => 'O campo {field} deve ser uma string valida.',
    ...
    // Custom
    'unique' => 'O {field} que você inseriu já está registrado.',
    'boolean' => 'O {field} deve ser marcado ou ignorado.',
    'currency' => 'O {field} deve conter uma moeda válida.',
    'valid_time' => 'O {field} deve conter um horário válido.',
    'valid_datetime' => 'O {field} deve conter uma data e hora válidas.',
    'valid_year' => 'O {field} deve conter um ano válido.',
    'valid_hex' => 'O {field} deve conter apenas código de cor hexadecimal.',
    'valid_geojson' => 'O {field} deve conter um GeoJSON válido.',
    'relation_checker' => 'Os dados de relação de {field} não foram encontrados.'
];
