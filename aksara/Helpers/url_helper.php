...
if (! function_exists('base_url')) {
    ...
    function base_url($method = '', $params = [])
    {
        ...
        if ((service('request')->getServer('HTTP_MOD_REWRITE') && strtolower(service('request')->getServer('HTTP_MOD_REWRITE')) == 'on') || (function_exists('apache_get_modules') && in_array('mod_rewrite', apache_get_modules())) || php_sapi_name() == 'fpm-fcgi' || file_exists(ROOTPATH . $uri) || file_exists(FCPATH . $uri)) {
